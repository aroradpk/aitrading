...
Write-Host ""
Write-Host "Git Bash (MINGW64) — use venv Python, not system 'python':"
Write-Host "  source .venv/Scripts/activate"
Write-Host "  ./scripts/venv-python.sh scripts/scan_historical_moves.py"
Write-Host "  ./scripts/venv-python.sh scripts/build_watchlist.py"
Write-Host ""
Write-Host "Optional rebuild watchlist from disk only (offline_mode: true in config/settings.yaml):"
Write-Host "  .\.venv\Scripts\python.exe scripts\run_pipeline.py"
Write-Host ""
